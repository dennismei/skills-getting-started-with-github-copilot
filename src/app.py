...
activities = {
    ...
    "Basketball Club": {
        "description": "Improving basketball skills and playing friendly games",
    ...
    "Drama Club": {
        ...
        "max_participants": 20,
        "participants": ["mia@mergington.edu", "julia@mergington.edu"]
    },
    "Debate Team": {
    ...
    "Science Club": {
        "description": "Explore experiments and scientific research topics",
